...
class Connection
{
	...
	function __construct($user, $pwd , $alias, $dbname)
	{
		$this->error = '';
	...
	function select($query,$class='\DotClear\Weblog\Recordset')
	{
		if (!$this->con_id) {
			return false;
		}
		...
		if ($class == '' || !class_exists($class)) {
			$class = '\DotClear\Weblog\Recordset';
		}
